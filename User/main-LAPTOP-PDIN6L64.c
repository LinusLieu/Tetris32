...
int main(void)
{
	...
	u8 absposx[12] = {65,98,115,80,111,115,95,88,0,0,0,0};
	u8 absposy[12] = {65,98,115,80,111,115,95,89,0,0,0,0};
	...
	for(i = 0;i<12;i++)
	{
		...
		IERG3810_TFTLCD_ShowChar(10 * (1+i),240,absposx[i],0xFFFF,0x0000);
		IERG3810_TFTLCD_ShowChar(10 * (1+i)+120,240,absposy[i],0xFFFF,0x0000);
	}
	...
	absx = block_pos_x - block_center_x;
	absy = block_pos_y - block_center_y;
	absposx[9] = absx / 10 % 10;
	absposx[10] = absx % 10;
	absposy[9] = absy / 10 % 10;
	absposy[10] = absy % 10;
	...
	for(i = 9;i<11;i++)
	{
		...
		IERG3810_TFTLCD_ShowChar(10 * (1+i),240,absposx[i]+48,0xFFFF,0x0000);
		IERG3810_TFTLCD_ShowChar(10 * (1+i)+120,240,absposy[i]+48,0xFFFF,0x0000);
	}
	*/
